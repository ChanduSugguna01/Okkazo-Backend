...
const authEventConsumer = require('./kafka/authEventConsumer');
...
const startServer = async () => {
  try {
    ...
    await authEventConsumer.initialize();
    await authEventConsumer.startConsuming();
    ...
    const server = app.listen(PORT, () => {
      ...
      logger.info(`Service: ${process.env.SERVICE_NAME || 'user-service'}`);
    });
